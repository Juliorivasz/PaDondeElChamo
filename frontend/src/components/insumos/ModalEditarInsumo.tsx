...
import { modificarInsumo } from "../../api/insumoApi"
...
export const ModalEditarInsumo: React.FC<Props> = ({ isOpen, onClose, alConfirmar, insumo }) => {
  ...
  const manejarEnvio = async (e: React.FormEvent): Promise<void> => {
    ...
    try {
      await modificarInsumo(insumo.idInsumo, formulario)
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-4 w-[95%] sm:w-full max-w-[600px] max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold text-gray-800">Editar Insumo</h2>
